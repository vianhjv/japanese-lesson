/* --- SCRIPT UNIVERSAL CHO CÁC BÀI HỌC VÀ BÀI TẬP (PHIÊN BẢN 2.1 - FIX RACE CONDITION) --- */
/* --- SCRIPT UNIVERSAL CHO CÁC BÀI HỌC VÀ BÀI TẬP (PHIÊN BẢN 2.2 - FIX INITIALIZATION) --- */
...
// === PHẦN CẬP NHẬT: ĐỔI MÀU NỀN KHI NGHE (CHAT & VOCAB) ===
    document.querySelectorAll('.vocab-play-btn').forEach(button => {
        button.addEventListener('click', (event) => {
            ...
            // Tìm khung bao quanh để đổi màu (Thẻ từ vựng hoặc Bong bóng chat)
            const wrapper = btn.closest('.vocab-card, .msg-bubble');
